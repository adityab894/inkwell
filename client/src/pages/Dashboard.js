...
import { PenLine, Eye, Heart, Clock, Edit3, Trash2, BarChart2, BookOpen, FileText, TrendingUp } from 'lucide-react';
        ...
        <div className="dashboard-articles animate-fade-up delay-200">
          ...
          {loading ? (
            ...
            <div className="empty-state">
              ...
              <Link to="/write" className="btn btn-primary" style={{ marginTop: '16px' }}>
              ...
              {filtered.map((article, i) => (
                <div key={article._id} className="article-row animate-fade-up" style={{ animationDelay: `${i * 0.05}s` }}>
                  ...
                  <div className="article-row__actions">
                    <Link to={`/write/${article._id}`} className="row-action-btn">
                      <Edit3 size={15} />
                    </Link>
